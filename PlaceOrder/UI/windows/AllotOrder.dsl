...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" controller="AllotOrderController" namespace="com.yonyou.placeorder" id="AllotOrder">  
    <import ref="AllotOrder.css" type="css"/>  
    ...
    <Scrollview vScrollEnabled="always" width="fill" hScrollEnabled="disabled" id="Scrollview_viewPage0" height="fill"> 
        <div id="viewPage0" onload="this.pageOnload()"> 
            <navigatorbar id="navigatorbar0" title="调拨单维护" class="navigatorbarclass"> 
