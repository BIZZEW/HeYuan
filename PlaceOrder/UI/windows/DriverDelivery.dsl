...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="DriverDelivery" controller="DriverDeliveryController" namespace="com.yonyou.placeorder">
    <import ref="DriverDelivery.css" type="css"/>
    <link type="text/css" href="sys/theme.css"/>
    <div id="viewPage0" onload="this.pageOnload()">
        <navigatorbar id="navigatorbar0" title="司机送货" class="navigatorbarclass">
