...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="ReceiveOrderSearch" controller="ReceiveOrderSearchController" namespace="com.yonyou.placeorder">
    <import ref="ReceiveOrderSearch.css" type="css"/>
    ...
    <div id="viewPage0" onload="this.pageOnload()">
        <div id="panel1">
            <navigatorbar id="navigatorbar0" title="送货单查询" class="navigatorbarclass">
