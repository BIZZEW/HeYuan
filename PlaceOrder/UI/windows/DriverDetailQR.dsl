...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" controller="DriverDetailQRController" namespace="com.yonyou.placeorder" id="DriverDetailQR">  
    <import ref="DriverDetailQR.css" type="css"/>  
    <link href="sys/theme.css" type="text/css"/>  
    <div id="viewPage0" onload="pageOnLoad()"> 
        <div id="panel0"> 
            <navigatorbar id="navigatorbar0" title="单据详情" class="navigatorbarclass"> 
