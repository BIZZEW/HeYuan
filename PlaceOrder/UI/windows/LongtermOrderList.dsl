...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="LongtermOrderList" controller="LongtermOrderListController" namespace="com.yonyou.placeorder">
    <import ref="LongtermOrderList.css" type="css"/>
    <link type="text/css" href="sys/theme.css"/>
    <div id="viewPage0" onload="this.pageOnload()">
        <navigatorbar id="navigatorbar0" title="长期送货单" class="navigatorbarclass">
