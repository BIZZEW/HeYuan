...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" controller="AllotOutSearchController" namespace="com.yonyou.placeorder" id="AllotOutSearch">
    <import ref="AllotOutSearch.css" type="css"/>
    ...
    <div id="viewPage0" onload="this.pageOnload()">
        <div id="panel1">
            <navigatorbar id="navigatorbar0" title="调拨出库查询" class="navigatorbarclass">
