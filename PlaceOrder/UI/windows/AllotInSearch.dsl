...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" controller="AllotInSearchController" namespace="com.yonyou.placeorder" id="AllotInSearch">
    <import ref="AllotInSearch.css" type="css"/>
    ...
    <div id="viewPage0" onload="this.pageOnload()">
        <div id="panel1">
            <navigatorbar id="navigatorbar0" title="调拨入库查询" class="navigatorbarclass">
