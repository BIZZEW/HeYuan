...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="DriverPickup" controller="DriverPickupController" namespace="com.yonyou.placeorder">
    <import ref="DriverPickup.css" type="css"/>
    <link type="text/css" href="sys/theme.css"/>
    <div id="viewPage0" onload="this.pageOnload()">
        <navigatorbar id="navigatorbar0" title="司机提货" class="navigatorbarclass">
