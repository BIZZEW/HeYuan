...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" controller="ReceiveOrderDetailController" namespace="com.yonyou.placeorder" id="ReceiveOrderDetail">  
    <import ref="ReceiveOrderDetail.css" type="css"/>  
    ...
    <Scrollview vScrollEnabled="always" width="fill" hScrollEnabled="disabled" id="Scrollview_viewPage0" height="fill"> 
        <div id="viewPage0" onload="this.pageOnload()"> 
            <navigatorbar id="navigatorbar0" title="送货单维护" class="navigatorbarclass"> 
            ...
            <div id="pnl_rcvorder"> 
                <div id="panel15"> 
                    <label id="label18">收货单号：</label>  
                    <label id="lbl_rcvordercode">收货单号</label> 
                </div>  
                <div id="panel16"> 
                    <label id="label20">收货单日期：</label>  
                ...
                <div id="panel1222"> 
                    <label id="label112">集装箱号：</label>  
                    <input maxlength="11" id="container_no" placeholder="集装箱号" type="text"/> 
                </div> 
