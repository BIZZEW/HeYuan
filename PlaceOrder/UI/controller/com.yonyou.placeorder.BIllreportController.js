...
try {
	...
	function com$yonyou$placeorder$BIllreportController$initialize() {
	...
	function com$yonyou$placeorder$BIllreportController$evaljs(js) {
		eval(js)
	}

	function com$yonyou$placeorder$BIllreportController$button0_onclick(sender, args) {
		$view.close()
	}
	...
	var userName;
	function com$yonyou$placeorder$BIllreportController$listviewdefine0_onload(sender, args) {
	...
	function com$yonyou$placeorder$BIllreportController$onitemcreate(sender, args) {
	...
	function com$yonyou$placeorder$BIllreportController$imagebutton0_onclick(sender, args) {
		$view.close();
	}
