...
try {
	Type.registerNamespace('com.yonyou.placeorder.LongtermOrderDetailController');
	com.yonyou.placeorder.LongtermOrderDetailController = function () {
		com.yonyou.placeorder.LongtermOrderDetailController.initializeBase(this);
		this.initialize();
	}
	function com$yonyou$placeorder$LongtermOrderDetailController$initialize() {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$evaljs(js) {
		eval(js)
	}

	function com$yonyou$placeorder$LongtermOrderDetailController$back_onclick(sender, args) {
		$view.close();
	}
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$pageOnload(sender, args) {
		var denddate = Globals.getFormatDate2(3);
		$id("denddate").set("value", denddate);
		...
		if (oldorder) {
			...
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder = oldorder;
			...
			com.yonyou.placeorder.LongtermOrderDetailController.ReceiveOrderObj = {
			...
			com.yonyou.placeorder.LongtermOrderDetailController.ReceiveOrderObj = {};
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder = {};
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.material = {};
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.purchaseorg = {};
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.rcvstockorg = {};
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.supplier = {};
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$changevender(sender, args) {
		var json = {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$selectOrderOnclick(sender, args) {
		$view.open({
			...
			"callback": function () {
				...
				if (purchaseOrder != undefined && purchaseOrder != null) {
					...
					//更新返回列表数据
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.material.pk_material = purchaseOrder["material"]["pk_material"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.material.name = purchaseOrder["material"]["name"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.material.dw = purchaseOrder["material"]["dw"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.purchaseorg.name = purchaseOrder["purchaseorg"]["name"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.rcvstockorg.pk_org = purchaseOrder["rcvstockorg"]["pk_org"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.rcvstockorg.name = purchaseOrder["rcvstockorg"]["name"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.supplier.pk_supplier = purchaseOrder["supplier"]["pk_supplier"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.supplier.name = purchaseOrder["supplier"]["name"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.pdbilldate = purchaseOrder["dbilldate"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.remainnum = purchaseOrder["remainnum"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.pk_order = purchaseOrder["pk_order"];
					com.yonyou.placeorder.LongtermOrderDetailController.oldorder.vbillcode = purchaseOrder["vbillcode"];
				}
			}
		});
	}
	function com$yonyou$placeorder$LongtermOrderDetailController$showDetail(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$fmtvlicenseOnclick(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$showFreeLicense(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$goselectcar(sender, args) {
		var pk_supplier = com.yonyou.placeorder.LongtermOrderDetailController.ReceiveOrderObj.pk_supplier;
		$view.open({
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$selectDriver(sender, args) {
		var isfldisplay = $id("txt_vlicense").get("display");
		var carno = "";
		if (isfldisplay == "none") {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$yfjzOnchange(sender, args) {
		$id("num_dhl").set("value", $id("num_yfjz").get("value"));
	}

	function com$yonyou$placeorder$LongtermOrderDetailController$submitOnclick(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$invalidOnclick(sender, args) {
	...
	function addConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			...
			com.yonyou.placeorder.LongtermOrderDetailController.pk_noticeorder = result.datas.pk_noticeorder;
	...
	function updateConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			$alert("修改收货单成功！");
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.srcsendnum = $id("num_yfjz").get("value");
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.num = $id("num_dhl").get("value");
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.vlicense = com.yonyou.placeorder.LongtermOrderDetailController.carno;
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.driveridcode = $id("txt_driverid").get("value");
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.drivertelephone = $id("txt_drivertelephone").get("value");
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.drivername = $id("txt_drivername").get("value");
			$view.closeWithCallBack({
				"result": com.yonyou.placeorder.LongtermOrderDetailController.oldorder
			});
		} else {
	...
	function invalidConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			$alert("取消收货单成功！");
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.status.code = -1;
			com.yonyou.placeorder.LongtermOrderDetailController.oldorder.status.name = "取消";
			$view.closeWithCallBack({
				"result": com.yonyou.placeorder.LongtermOrderDetailController.oldorder
			});
		} else {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$button0_onclick(sender, args) {
		$view.close();
	}
	function com$yonyou$placeorder$LongtermOrderDetailController$shareOnClick(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderDetailController$jumpToSharePage(sender, args) {
		var vlicense = $id("txt_vlicense").get("value");
		//车牌号
		var isfldisplay = $id("txt_vlicense").get("display");
		if (isfldisplay == "none") {
		...
		if (com.yonyou.placeorder.LongtermOrderDetailController.ReceiveOrderObj && com.yonyou.placeorder.LongtermOrderDetailController.ReceiveOrderObj.pk_noticeorder) {
			pk_rcvbill = com.yonyou.placeorder.LongtermOrderDetailController.ReceiveOrderObj.pk_noticeorder;
		} else {
			pk_rcvbill = com.yonyou.placeorder.LongtermOrderDetailController.pk_noticeorder;
		}
		var params = {
			"vlicense": vlicense,
			"splrname": splrname,
	...
	//end
	com.yonyou.placeorder.LongtermOrderDetailController.prototype = {
		jumpToSharePage: com$yonyou$placeorder$LongtermOrderDetailController$jumpToSharePage,
		fmtvlicenseOnclick: com$yonyou$placeorder$LongtermOrderDetailController$fmtvlicenseOnclick,
		shareOnClick: com$yonyou$placeorder$LongtermOrderDetailController$shareOnClick,
		selectDriver: com$yonyou$placeorder$LongtermOrderDetailController$selectDriver,
		showFreeLicense: com$yonyou$placeorder$LongtermOrderDetailController$showFreeLicense,
		showDetail: com$yonyou$placeorder$LongtermOrderDetailController$showDetail,
		button0_onclick: com$yonyou$placeorder$LongtermOrderDetailController$button0_onclick,
		selectOrderOnclick: com$yonyou$placeorder$LongtermOrderDetailController$selectOrderOnclick,
		invalidOnclick: com$yonyou$placeorder$LongtermOrderDetailController$invalidOnclick,
		submitOnclick: com$yonyou$placeorder$LongtermOrderDetailController$submitOnclick,
		yfjzOnchange: com$yonyou$placeorder$LongtermOrderDetailController$yfjzOnchange,
		goselectcar: com$yonyou$placeorder$LongtermOrderDetailController$goselectcar,
		pageOnload: com$yonyou$placeorder$LongtermOrderDetailController$pageOnload,
		back_onclick: com$yonyou$placeorder$LongtermOrderDetailController$back_onclick,
		initialize: com$yonyou$placeorder$LongtermOrderDetailController$initialize,
		evaljs: com$yonyou$placeorder$LongtermOrderDetailController$evaljs,
		changevender: com$yonyou$placeorder$LongtermOrderDetailController$changevender,
	};
	com.yonyou.placeorder.LongtermOrderDetailController.registerClass('com.yonyou.placeorder.LongtermOrderDetailController', UMP.UI.Mvc.Controller);
} catch (e) {
	$e(e);
}