...
try {
	...
	function com$yonyou$placeorder$SalesAdvOrderDetailController$initialize() {
	...
	function com$yonyou$placeorder$SalesAdvOrderDetailController$evaljs(js) {
		eval(js)
	}
	...
	//提交订单
	function com$yonyou$placeorder$SalesAdvOrderDetailController$postbill(sender, args) {
		if (!cmaterialid) {
			$alert("请选择物料");
			return;
		}
