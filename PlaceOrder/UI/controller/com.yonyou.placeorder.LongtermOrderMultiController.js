...
try {
	Type.registerNamespace('com.yonyou.placeorder.LongtermOrderMultiController');
	com.yonyou.placeorder.LongtermOrderMultiController = function () {
		com.yonyou.placeorder.LongtermOrderMultiController.initializeBase(this);
		this.initialize();
	}
	function com$yonyou$placeorder$LongtermOrderMultiController$initialize() {
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$evaljs(js) {
		eval(js)
	}

	function com$yonyou$placeorder$LongtermOrderMultiController$back_onclick(sender, args) {
		$view.close();
	}
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$pageOnload(sender, args) {
		...
		if (oldorder) {
			...
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder = oldorder;
			...
			com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj = {
			...
			com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj = {};
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder = {};
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.material = {};
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.purchaseorg = {};
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.rcvstockorg = {};
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.supplier = {};
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$changevender(sender, args) {
		var json = {
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$selectOrderOnclick(sender, args) {
		$view.open({
			...
			"callback": function () {
				...
				if (purchaseOrder != undefined && purchaseOrder != null) {
					...
					var orderobj = com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj;
					...
					//更新返回列表数据
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.material.pk_material = purchaseOrder["material"]["pk_material"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.material.name = purchaseOrder["material"]["name"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.material.dw = purchaseOrder["material"]["dw"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.purchaseorg.name = purchaseOrder["purchaseorg"]["name"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.rcvstockorg.pk_org = purchaseOrder["rcvstockorg"]["pk_org"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.rcvstockorg.name = purchaseOrder["rcvstockorg"]["name"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.supplier.pk_supplier = purchaseOrder["supplier"]["pk_supplier"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.supplier.name = purchaseOrder["supplier"]["name"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.pdbilldate = purchaseOrder["dbilldate"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.remainnum = purchaseOrder["remainnum"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.pk_order = purchaseOrder["pk_order"];
					com.yonyou.placeorder.LongtermOrderMultiController.oldorder.vbillcode = purchaseOrder["vbillcode"];
				}
			}
		});
	}
	function com$yonyou$placeorder$LongtermOrderMultiController$showDetail(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$fmtvlicenseOnclick(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$showFreeLicense(sender, args) {
	...
	function changevehicles(sender, args) {
		var pk_supplier = com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj.pk_supplier;
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$goselectcar(sender, args) {
		var pk_supplier = com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj.pk_supplier;
		$view.open({
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$selectDriver(sender, args) {
		var isfldisplay = $id("txt_vlicense").get("display");
		var carno = "";
		if (isfldisplay == "none") {
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$yfjzOnchange(sender, args) {
		$id("num_dhl").set("value", $id("num_yfjz").get("value"));
	}

	function com$yonyou$placeorder$LongtermOrderMultiController$submitOnclick(sender, args) {
		...
		// 	return;
		// }
		// com.yonyou.placeorder.LongtermOrderMultiController.carno = vlicense;
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$invalidOnclick(sender, args) {
	...
	function addConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			...
			com.yonyou.placeorder.LongtermOrderMultiController.pk_noticeorder = result.datas.pk_noticeorder;
	...
	function updateConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			$alert("修改收货单成功！");
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.srcsendnum = $id("num_yfjz").get("value");
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.num = $id("num_dhl").get("value");
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.vlicense = com.yonyou.placeorder.LongtermOrderMultiController.carno;
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.driveridcode = $id("txt_driverid").get("value");
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.drivertelephone = $id("txt_drivertelephone").get("value");
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.drivername = $id("txt_drivername").get("value");
			$view.closeWithCallBack({
				"result": com.yonyou.placeorder.LongtermOrderMultiController.oldorder
			});
		} else {
	...
	function invalidConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			$alert("取消收货单成功！");
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.status.code = -1;
			com.yonyou.placeorder.LongtermOrderMultiController.oldorder.status.name = "取消";
			$view.closeWithCallBack({
				"result": com.yonyou.placeorder.LongtermOrderMultiController.oldorder
			});
		} else {
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$button0_onclick(sender, args) {
		$view.close();
	}
	function com$yonyou$placeorder$LongtermOrderMultiController$shareOnClick(sender, args) {
	...
	function com$yonyou$placeorder$LongtermOrderMultiController$jumpToSharePage(sender, args) {
		var vlicense = $id("txt_vlicense").get("value");
		//车牌号
		var isfldisplay = $id("txt_vlicense").get("display");
		if (isfldisplay == "none") {
		...
		if (com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj && com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj.pk_noticeorder) {
			pk_rcvbill = com.yonyou.placeorder.LongtermOrderMultiController.ReceiveOrderObj.pk_noticeorder;
		} else {
			pk_rcvbill = com.yonyou.placeorder.LongtermOrderMultiController.pk_noticeorder;
		}
		var params = {
			"vlicense": vlicense,
			"splrname": splrname,
	...
	//end
	com.yonyou.placeorder.LongtermOrderMultiController.prototype = {
		jumpToSharePage: com$yonyou$placeorder$LongtermOrderMultiController$jumpToSharePage,
		fmtvlicenseOnclick: com$yonyou$placeorder$LongtermOrderMultiController$fmtvlicenseOnclick,
		shareOnClick: com$yonyou$placeorder$LongtermOrderMultiController$shareOnClick,
		selectDriver: com$yonyou$placeorder$LongtermOrderMultiController$selectDriver,
		showFreeLicense: com$yonyou$placeorder$LongtermOrderMultiController$showFreeLicense,
		showDetail: com$yonyou$placeorder$LongtermOrderMultiController$showDetail,
		button0_onclick: com$yonyou$placeorder$LongtermOrderMultiController$button0_onclick,
		selectOrderOnclick: com$yonyou$placeorder$LongtermOrderMultiController$selectOrderOnclick,
		invalidOnclick: com$yonyou$placeorder$LongtermOrderMultiController$invalidOnclick,
		submitOnclick: com$yonyou$placeorder$LongtermOrderMultiController$submitOnclick,
		yfjzOnchange: com$yonyou$placeorder$LongtermOrderMultiController$yfjzOnchange,
		goselectcar: com$yonyou$placeorder$LongtermOrderMultiController$goselectcar,
		pageOnload: com$yonyou$placeorder$LongtermOrderMultiController$pageOnload,
		back_onclick: com$yonyou$placeorder$LongtermOrderMultiController$back_onclick,
		initialize: com$yonyou$placeorder$LongtermOrderMultiController$initialize,
		evaljs: com$yonyou$placeorder$LongtermOrderMultiController$evaljs,
		changevender: com$yonyou$placeorder$LongtermOrderMultiController$changevender,
	};
	com.yonyou.placeorder.LongtermOrderMultiController.registerClass('com.yonyou.placeorder.LongtermOrderMultiController', UMP.UI.Mvc.Controller);
} catch (e) {
	$e(e);
}