...
try {
	Type.registerNamespace('com.yonyou.placeorder.ReceiveOrderMultiController');
	com.yonyou.placeorder.ReceiveOrderMultiController = function () {
		com.yonyou.placeorder.ReceiveOrderMultiController.initializeBase(this);
		this.initialize();
	}
	function com$yonyou$placeorder$ReceiveOrderMultiController$initialize() {
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$evaljs(js) {
		eval(js)
	}

	function com$yonyou$placeorder$ReceiveOrderMultiController$back_onclick(sender, args) {
		$view.close();
	}
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$pageOnload(sender, args) {
		...
		if (oldorder) {
			...
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder = oldorder;
			// alert(JSON.stringify(oldorder));
			...
			com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj = {
			...
			com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj = {};
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder = {};
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.material = {};
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.purchaseorg = {};
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.rcvstockorg = {};
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.supplier = {};
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$changevender(sender, args) {
		var json = {
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$selectOrderOnclick(sender, args) {
		$view.open({
			...
			"callback": function () {
				...
				if (purchaseOrder != undefined && purchaseOrder != null) {
					...
					var orderobj = com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj;
					...
					//更新返回列表数据
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.material.pk_material = purchaseOrder["material"]["pk_material"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.material.name = purchaseOrder["material"]["name"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.material.dw = purchaseOrder["material"]["dw"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.purchaseorg.name = purchaseOrder["purchaseorg"]["name"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.rcvstockorg.pk_org = purchaseOrder["rcvstockorg"]["pk_org"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.rcvstockorg.name = purchaseOrder["rcvstockorg"]["name"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.supplier.pk_supplier = purchaseOrder["supplier"]["pk_supplier"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.supplier.name = purchaseOrder["supplier"]["name"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.pdbilldate = purchaseOrder["dbilldate"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.remainnum = purchaseOrder["remainnum"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.pk_order = purchaseOrder["pk_order"];
					com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.vbillcode = purchaseOrder["vbillcode"];
				}
			}
		});
	}
	function com$yonyou$placeorder$ReceiveOrderMultiController$showDetail(sender, args) {
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$fmtvlicenseOnclick(sender, args) {
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$showFreeLicense(sender, args) {
	...
	function changevehicles(sender, args) {
		var pk_supplier = com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj.pk_supplier;
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$goselectcar(sender, args) {
		var pk_supplier = com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj.pk_supplier;
		$view.open({
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$selectDriver(sender, args) {
		var isfldisplay = $id("txt_vlicense").get("display");
		var carno = "";
		if (isfldisplay == "none") {
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$yfjzOnchange(sender, args) {
		$id("num_dhl").set("value", $id("num_yfjz").get("value"));
	}

	function com$yonyou$placeorder$ReceiveOrderMultiController$submitOnclick(sender, args) {
		// pageFresh();
		...
		// 	return;
		// }
		// com.yonyou.placeorder.ReceiveOrderMultiController.carno = vlicense;
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$invalidOnclick(sender, args) {
	...
	function addConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			...
			com.yonyou.placeorder.ReceiveOrderMultiController.pk_noticeorder = result.datas.pk_noticeorder;
	...
	function updateConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			$alert("修改收货单成功！");
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.srcsendnum = $id("num_yfjz").get("value");
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.num = $id("num_dhl").get("value");
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.vlicense = com.yonyou.placeorder.ReceiveOrderMultiController.carno;
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.driveridcode = $id("txt_driverid").get("value");
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.drivertelephone = $id("txt_drivertelephone").get("value");
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.drivername = $id("txt_drivername").get("value");
			$view.closeWithCallBack({
				"result": com.yonyou.placeorder.ReceiveOrderMultiController.oldorder
			});
		} else {
	...
	function invalidConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			$alert("取消收货单成功！");
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.status.code = -1;
			com.yonyou.placeorder.ReceiveOrderMultiController.oldorder.status.name = "取消";
			$view.closeWithCallBack({
				"result": com.yonyou.placeorder.ReceiveOrderMultiController.oldorder
			});
		} else {
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$button0_onclick(sender, args) {
		$view.close();
	}
	function com$yonyou$placeorder$ReceiveOrderMultiController$shareOnClick(sender, args) {
	...
	function com$yonyou$placeorder$ReceiveOrderMultiController$jumpToSharePage(sender, args) {
		var vlicense = $id("txt_vlicense").get("value");
		//车牌号
		var isfldisplay = $id("txt_vlicense").get("display");
		if (isfldisplay == "none") {
		...
		if (com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj && com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj.pk_noticeorder) {
			pk_rcvbill = com.yonyou.placeorder.ReceiveOrderMultiController.ReceiveOrderObj.pk_noticeorder;
		} else {
			pk_rcvbill = com.yonyou.placeorder.ReceiveOrderMultiController.pk_noticeorder;
		}
		var params = {
			"vlicense": vlicense,
			"splrname": splrname,
	...
	//end
	com.yonyou.placeorder.ReceiveOrderMultiController.prototype = {
		jumpToSharePage: com$yonyou$placeorder$ReceiveOrderMultiController$jumpToSharePage,
		fmtvlicenseOnclick: com$yonyou$placeorder$ReceiveOrderMultiController$fmtvlicenseOnclick,
		shareOnClick: com$yonyou$placeorder$ReceiveOrderMultiController$shareOnClick,
		selectDriver: com$yonyou$placeorder$ReceiveOrderMultiController$selectDriver,
		showFreeLicense: com$yonyou$placeorder$ReceiveOrderMultiController$showFreeLicense,
		showDetail: com$yonyou$placeorder$ReceiveOrderMultiController$showDetail,
		button0_onclick: com$yonyou$placeorder$ReceiveOrderMultiController$button0_onclick,
		selectOrderOnclick: com$yonyou$placeorder$ReceiveOrderMultiController$selectOrderOnclick,
		invalidOnclick: com$yonyou$placeorder$ReceiveOrderMultiController$invalidOnclick,
		submitOnclick: com$yonyou$placeorder$ReceiveOrderMultiController$submitOnclick,
		yfjzOnchange: com$yonyou$placeorder$ReceiveOrderMultiController$yfjzOnchange,
		goselectcar: com$yonyou$placeorder$ReceiveOrderMultiController$goselectcar,
		pageOnload: com$yonyou$placeorder$ReceiveOrderMultiController$pageOnload,
		back_onclick: com$yonyou$placeorder$ReceiveOrderMultiController$back_onclick,
		initialize: com$yonyou$placeorder$ReceiveOrderMultiController$initialize,
		evaljs: com$yonyou$placeorder$ReceiveOrderMultiController$evaljs,
		changevender: com$yonyou$placeorder$ReceiveOrderMultiController$changevender,
	};
	com.yonyou.placeorder.ReceiveOrderMultiController.registerClass('com.yonyou.placeorder.ReceiveOrderMultiController', UMP.UI.Mvc.Controller);
} catch (e) {
	$e(e);
}
