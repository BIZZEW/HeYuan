...
try {
	Type.registerNamespace('com.yonyou.placeorder.DetailreportController');
	com.yonyou.placeorder.DetailreportController = function () {
		com.yonyou.placeorder.DetailreportController.initializeBase(this);
		this.initialize();
	}
	function com$yonyou$placeorder$DetailreportController$initialize() {
	...
	function com$yonyou$placeorder$DetailreportController$evaljs(js) {
		eval(js)
	}

	function com$yonyou$placeorder$DetailreportController$button0_onclick(sender, args) {
		$view.close()
	}
	...
	var userName;
	function com$yonyou$placeorder$DetailreportController$listviewdefine0_onload(sender, args) {
	...
	function com$yonyou$placeorder$DetailreportController$requestData() {
		$js.showLoadingBar();
	...
	function com$yonyou$placeorder$DetailreportController$pageOnload(sender, args) {
		$js.runjs({
			"controlid": "webcontrol1",//webControl的id
	...
	function com$yonyou$placeorder$DetailreportController$onitemcreate(sender, args) {
	...
	function com$yonyou$placeorder$DetailreportController$onitemclick(sender, args) {
	...
	//下滑刷新
	function com$yonyou$placeorder$DetailreportController$ondownrefresh(sender, args) {
		pageIndex++;
		$service.callAction({
			"viewid": "com.yonyou.uap.haiguan.HaiguanController", //后台Controller(带包名)的类名
			"action": action, //后台Controller的方法名,
	...
	function com$yonyou$placeorder$DetailreportController$imagebutton0_onclick(sender, args) {
		$view.close();
	}


	com.yonyou.placeorder.DetailreportController.prototype = {
		imagebutton0_onclick: com$yonyou$placeorder$DetailreportController$imagebutton0_onclick,
		ondownrefresh: com$yonyou$placeorder$DetailreportController$ondownrefresh,
		onitemclick: com$yonyou$placeorder$DetailreportController$onitemclick,
		onitemcreate: com$yonyou$placeorder$DetailreportController$onitemcreate,
		listviewdefine0_onload: com$yonyou$placeorder$DetailreportController$listviewdefine0_onload,
		initialize: com$yonyou$placeorder$DetailreportController$initialize,
		evaljs: com$yonyou$placeorder$DetailreportController$evaljs,
		button0_onclick: com$yonyou$placeorder$DetailreportController$button0_onclick,
		requestData: com$yonyou$placeorder$DetailreportController$requestData,
		goSearch: com$yonyou$placeorder$DetailreportController$goSearch,
		pageOnload: com$yonyou$placeorder$DetailreportController$pageOnload,
	};
	com.yonyou.placeorder.DetailreportController.registerClass('com.yonyou.placeorder.DetailreportController', UMP.UI.Mvc.Controller);
} catch (e) {
	$e(e);
}
