...
try {
	...
	function com$yonyou$placeorder$ReceiveOrderSearchController$changeMine(sender, args) {
		$view.open({
			"viewid": "com.yonyou.placeorder.BaseInfoRefWindow",
			"isKeep": "true",
			...
			"callback": function () {
				...
				com.yonyou.placeorder.ReceiveOrderSearchController.pk_orespot = retvalue.pk;
				$id("txt_mine").set("value", retvalue.name);
			}
		});
	}
	function com$yonyou$placeorder$ReceiveOrderSearchController$clearMine(sender, args) {
