...
try {
	...
	function com$yonyou$placeorder$DriverPickupSearchController$menu11_onclick(sender, args) {
		$view.open({
	...
	function com$yonyou$placeorder$DriverPickupSearchController$onload(sender, args) {
		$id("label1").set("value", $cache.read("userName"));
		$js.backConfirm();
	}

	function com$yonyou$placeorder$DriverPickupSearchController$openDeclareList(sender, args) {
		$view.open({
...
function com$yonyou$placeorder$DriverPickupSearchController$menu23_onclick(sender, args){
	$view.open({
		"viewid" : "com.yonyou.hgdeclare.DeclareChart",//目标页面（首字母大写）全名，
		"isKeep" : "true"
	});
}	com.yonyou.placeorder.DriverPickupSearchController.prototype = {
    menu23_onclick : com$yonyou$placeorder$DriverPickupSearchController$menu23_onclick,
		openDeclareList : com$yonyou$placeorder$DriverPickupSearchController$openDeclareList,
		onload : com$yonyou$placeorder$DriverPickupSearchController$onload,
		menu11_onclick : com$yonyou$placeorder$DriverPickupSearchController$menu11_onclick,
