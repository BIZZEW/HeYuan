...
try {
	Type.registerNamespace('com.yonyou.placeorder.LongtermSaleMultiController');
	com.yonyou.placeorder.LongtermSaleMultiController = function () {
		com.yonyou.placeorder.LongtermSaleMultiController.initializeBase(this);
		this.initialize();
	}
	function com$yonyou$placeorder$LongtermSaleMultiController$initialize() {
	...
	function com$yonyou$placeorder$LongtermSaleMultiController$evaljs(js) {
		eval(js)
	}

	function com$yonyou$placeorder$LongtermSaleMultiController$button0_onclick(sender, args) {
		$view.close()
	}
	function com$yonyou$placeorder$LongtermSaleMultiController$testInput(sender, args) {
		var params = {
			"viewid": "pnl_input",
			"isTouch": "true",
			"single": "true",
	...
	function com$yonyou$placeorder$LongtermSaleMultiController$testInput2(sender, args) {
	...
	function com$yonyou$placeorder$LongtermSaleMultiController$changebill(sender, args) {
		...
		if (data) {
			com.yonyou.placeorder.LongtermSaleMultiController.olddata = data;
			...
			$id("denddate").set("value", (data["denddate"]).substring(0, 10));
	...
	//修改客户
	function com$yonyou$placeorder$LongtermSaleMultiController$changecustomer(sender, args) {
		$view.open({
	...
	function changecustomerbac() {
		...
		if (com.yonyou.placeorder.LongtermSaleMultiController.olddata) {
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.ccustomerid.name = retvalue.name;
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.ccustomerid.pk_customer = retvalue.pk;
		}
	}
	//修改销售单位
	function com$yonyou$placeorder$LongtermSaleMultiController$changeseller(sender, args) {
	...
	function changesellerbac() {
		...
		saleorg = retvalue.pk;
		if (com.yonyou.placeorder.LongtermSaleMultiController.olddata) {
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.saleorg.name = retvalue.name;
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.saleorg.pk_org = retvalue.pk;
		}
	}
	//修改发货企业
	function com$yonyou$placeorder$LongtermSaleMultiController$changesender(sender, args) {
		$view.open({
			viewid: "com.yonyou.placeorder.BaseInfoRefWindow", //目标页面（首字母大写）全名
			isKeep: "true", //打开新页面的同时是否保留当前页面，true为保留，false为不保留
	...
	function changesenderbac() {
		...
		if (com.yonyou.placeorder.LongtermSaleMultiController.olddata) {
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.sendstockorg.name = retvalue.name;
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.sendstockorg.pk_org = retvalue.pk;
		}
	}
	//修改货物
	...
	function changgoods() {
		...
		if (com.yonyou.placeorder.LongtermSaleMultiController.olddata) {
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.cmaterialid.name = retvalue.name;
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.cmaterialid.pk_material = retvalue.pk;
		}
	}
	//修改车牌
	function com$yonyou$placeorder$LongtermSaleMultiController$fmtvlicenseOnclick(sender, args) {
	...
	function com$yonyou$placeorder$LongtermSaleMultiController$freelicenseOnclick(sender, args) {
	...
	//修改参照车牌
	function com$yonyou$placeorder$LongtermSaleMultiController$changecar(sender, args) {
		$view.open({
			viewid: "com.yonyou.placeorder.BaseInfoRefWindow", //目标页面（首字母大写）全名
			isKeep: "true", //打开新页面的同时是否保留当前页面，true为保留，false为不保留
			"otherparams": {
	...
	//修改司机参照
	function com$yonyou$placeorder$LongtermSaleMultiController$selectDriverOnclick(sender, args) {
		var isfldisplay = $id("pnl_carno").get("display");
		var carno = "";
		if (isfldisplay == "none") {
	...
	//提交订单
	function com$yonyou$placeorder$LongtermSaleMultiController$postbill(sender, args) {
		...
		// 	}
		// }
		// com.yonyou.placeorder.LongtermSaleMultiController.carno = carno;
	...
	function addsuccess() {
		...
		if (status == "1001004") {
			...
			$alert("提交成功");
			if (com.yonyou.placeorder.LongtermSaleMultiController.olddata) {
				com.yonyou.placeorder.LongtermSaleMultiController.olddata.ordernum = $id("weight").get("value");
				com.yonyou.placeorder.LongtermSaleMultiController.olddata.vnote = $id("vnote").get("value");
				com.yonyou.placeorder.LongtermSaleMultiController.olddata.vlicense = com.yonyou.placeorder.LongtermSaleMultiController.carno;
				com.yonyou.placeorder.LongtermSaleMultiController.olddata.vdriverid = $id("driverid").get("value");
				com.yonyou.placeorder.LongtermSaleMultiController.olddata.drivertelephone = $id("drivertel").get("value");
				com.yonyou.placeorder.LongtermSaleMultiController.olddata.drivername = $id("drivername").get("value");
				$view.closeWithCallBack({
					"result": com.yonyou.placeorder.LongtermSaleMultiController.olddata
				});
			} else {
				$view.close();
			}
	...
	//取消订单
	function com$yonyou$placeorder$LongtermSaleMultiController$invalid_onclick(sender, args) {
		$window.showModalDialog({
	...
	function invalidsuccess() {
		...
		if (status == "0") {
			$alert("已取消");
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.billstatus.code = 7;
			com.yonyou.placeorder.LongtermSaleMultiController.olddata.billstatus.name = "单据失效";
			$view.closeWithCallBack({
				"result": com.yonyou.placeorder.LongtermSaleMultiController.olddata
			});
		} else if (status == "1") {
	...
	com.yonyou.placeorder.LongtermSaleMultiController.prototype = {
		fmtvlicenseOnclick: com$yonyou$placeorder$LongtermSaleMultiController$fmtvlicenseOnclick,
		testInput2: com$yonyou$placeorder$LongtermSaleMultiController$testInput2,
		testInput: com$yonyou$placeorder$LongtermSaleMultiController$testInput,
		selectDriverOnclick: com$yonyou$placeorder$LongtermSaleMultiController$selectDriverOnclick,
		freelicenseOnclick: com$yonyou$placeorder$LongtermSaleMultiController$freelicenseOnclick,
		invalid_onclick: com$yonyou$placeorder$LongtermSaleMultiController$invalid_onclick,
		changebill: com$yonyou$placeorder$LongtermSaleMultiController$changebill,
		postbill: com$yonyou$placeorder$LongtermSaleMultiController$postbill,
		changecar: com$yonyou$placeorder$LongtermSaleMultiController$changecar,
		changecustomer: com$yonyou$placeorder$LongtermSaleMultiController$changecustomer,
		changesender: com$yonyou$placeorder$LongtermSaleMultiController$changesender,
		changeseller: com$yonyou$placeorder$LongtermSaleMultiController$changeseller,
		button0_onclick: com$yonyou$placeorder$LongtermSaleMultiController$button0_onclick,
		initialize: com$yonyou$placeorder$LongtermSaleMultiController$initialize,
		evaljs: com$yonyou$placeorder$LongtermSaleMultiController$evaljs
	};
	com.yonyou.placeorder.LongtermSaleMultiController.registerClass('com.yonyou.placeorder.LongtermSaleMultiController', UMP.UI.Mvc.Controller);
} catch (e) {
	$e(e);
}
