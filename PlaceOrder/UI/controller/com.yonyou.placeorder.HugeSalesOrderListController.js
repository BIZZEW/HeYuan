...
try {
	...
	function com$yonyou$placeorder$HugeSalesOrderListController$selectMatOnclick(sender, args) {
		var pk_customer = com.yonyou.placeorder.HugeSalesOrderListController.queryparam["ccustomerid"];
		if (com.yonyou.placeorder.HugeSalesOrderListController.queryparam["pk_saleorg"]) {
			var otherparams = {
				"pk_stockorg": com.yonyou.placeorder.HugeSalesOrderListController.queryparam["pk_saleorg"],
				"pk_customer": pk_customer,
				"issaleorder": true
			};
			$view.open({
