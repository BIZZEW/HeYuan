...
try {
	Type.registerNamespace('com.yonyou.placeorder.HugeController');
	...
	function pageFresh() {
		...
		$id("lbl_orderno").set("value", "请选择销售订单");
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$pageOnload(sender, args) {
		...
		if (oldorder) {
			...
			com.yonyou.placeorder.HugeDeliverOrderController.ReceiveOrderObj = {
			...
			com.yonyou.placeorder.HugeDeliverOrderController.oldorder.material = {};
			com.yonyou.placeorder.HugeDeliverOrderController.oldorder.purchaseorg = {};
			com.yonyou.placeorder.HugeDeliverOrderController.oldorder.rcvstockorg = {};
			com.yonyou.placeorder.HugeDeliverOrderController.oldorder.supplier = {};
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$changevender(sender, args) {
		var json = {
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$selectOrderOnclick(sender, args) {
		$view.open({
			...
			"callback": function () {
				...
				if (purchaseOrder != undefined && purchaseOrder != null) {
					...
					var orderobj = com.yonyou.placeorder.HugeDeliverOrderController.ReceiveOrderObj;
					...
					//更新返回列表数据
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.material.pk_material = purchaseOrder["material"]["pk_material"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.material.name = purchaseOrder["material"]["name"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.material.dw = purchaseOrder["material"]["dw"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.purchaseorg.name = purchaseOrder["purchaseorg"]["name"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.rcvstockorg.pk_org = purchaseOrder["rcvstockorg"]["pk_org"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.rcvstockorg.name = purchaseOrder["rcvstockorg"]["name"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.supplier.pk_supplier = purchaseOrder["supplier"]["pk_supplier"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.supplier.name = purchaseOrder["supplier"]["name"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.pdbilldate = purchaseOrder["dbilldate"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.remainnum = purchaseOrder["remainnum"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.pk_order = purchaseOrder["pk_order"];
					com.yonyou.placeorder.HugeDeliverOrderController.oldorder.vbillcode = purchaseOrder["vbillcode"];
				}
			}
		});
	}
	function com$yonyou$placeorder$HugeDeliverOrderController$showDetail(sender, args) {
	...
	function changevehicles(sender, args) {
		var pk_supplier = com.yonyou.placeorder.HugeDeliverOrderController.ReceiveOrderObj.pk_supplier;
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$goselectcar(sender, args) {
		var pk_supplier = com.yonyou.placeorder.HugeDeliverOrderController.ReceiveOrderObj.pk_supplier;
		$view.open({
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$selectDriver(sender, args) {
		var isfldisplay = $id("txt_vlicense").get("display");
		var carno = "";
		if (isfldisplay == "none") {
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$yfjzOnchange(sender, args) {
	...
	function updateConnectSuccess() {
		...
		if (result && result.statuscode == "0") {
			$alert("修改收货单成功！");
			com.yonyou.placeorder.HugeDeliverOrderController.oldorder.srcsendnum = $id("num_yfjz").get("value");
			com.yonyou.placeorder.HugeDeliverOrderController.oldorder.num = $id("num_dhl").get("value");
			...
			com.yonyou.placeorder.HugeDeliverOrderController.oldorder.driveridcode = $id("txt_driverid").get("value");
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$button0_onclick(sender, args) {
		$view.close();
	}
	...
	function com$yonyou$placeorder$HugeDeliverOrderController$jumpToSharePage(sender, args) {
		var vlicense = $id("txt_vlicense").get("value");
		//车牌号
		var isfldisplay = $id("txt_vlicense").get("display");
		if (isfldisplay == "none") {
		...
		if (com.yonyou.placeorder.HugeDeliverOrderController.ReceiveOrderObj && com.yonyou.placeorder.HugeDeliverOrderController.ReceiveOrderObj.pk_noticeorder) {
			pk_rcvbill = com.yonyou.placeorder.HugeDeliverOrderController.ReceiveOrderObj.pk_noticeorder;
		} else {
			pk_rcvbill = com.yonyou.placeorder.HugeDeliverOrderController.pk_noticeorder;
		}
		var params = {
			"vlicense": vlicense,
			"splrname": splrname,
	...
	com.yonyou.placeorder.HugeDeliverOrderController.prototype = {
		jumpToSharePage: com$yonyou$placeorder$HugeDeliverOrderController$jumpToSharePage,
		...
		selectDriver: com$yonyou$placeorder$HugeDeliverOrderController$selectDriver,
		showFreeLicense: com$yonyou$placeorder$HugeDeliverOrderController$showFreeLicense,
		showDetail: com$yonyou$placeorder$HugeDeliverOrderController$showDetail,
		button0_onclick: com$yonyou$placeorder$HugeDeliverOrderController$button0_onclick,
		selectOrderOnclick: com$yonyou$placeorder$HugeDeliverOrderController$selectOrderOnclick,
		...
		yfjzOnchange: com$yonyou$placeorder$HugeDeliverOrderController$yfjzOnchange,
		goselectcar: com$yonyou$placeorder$HugeDeliverOrderController$goselectcar,
		...
		changevender: com$yonyou$placeorder$HugeDeliverOrderController$changevender,
	};
